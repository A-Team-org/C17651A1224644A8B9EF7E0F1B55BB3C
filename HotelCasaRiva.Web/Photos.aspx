        ...
        <div class="container">
            ...
            <div class="delicious-grids">
                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Exterior.jpg" />
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Front%20View.jpg" />
                        <div class="sub-title"><a><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Front View</a></div>
                        <p style="display: none">Located in Suburb and surrounded by greenery, the Courtyard by Marriott Surat Hotel offers a tranquil retreat here in the bustling city.</p>
                    </div>
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Lobby1.jpeg" />
                ...
                <div class="col-md-12" style="display:none;">
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/room/26.jpg" />
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/room/27.jpg" />
                ...
                <div class="col-md-12" style="display:none;">
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Dining2.jpeg" />
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Dining4.jpg" />
                ...
                <div class="col-md-12" style="display:none;">
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Pool.jpg" />
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Fitness.jpg" />
                ...
                <div class="col-md-12" style="display:none;">
                    ...
                    <div class="col-md-3 delicious-grid">
                        <%--				<h3>PASTA SPECIAL</h3>--%>
                        <img src="Content/Images/PhotosPage/Events.jpeg" />
